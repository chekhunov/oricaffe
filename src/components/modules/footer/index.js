          ...
          <div className="w100p d-flex justify-between">
            ...
            <div className="footer__item">
              ...
              <ul className="socials d-flex align-center">
                ...
                <li className="socials__item">
                  <a className="socials__link instagram" href="/" target="_blank">
                    <svg width="34" height="34" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                ...
                <li className="socials__item">
                  <a className="socials__link facebook" href="/" target="_blank">
                    <svg width="34" height="34" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                ...
                <li className="socials__item">
                  <a className="socials__link twitter" href="/" target="_blank">
                    <svg
