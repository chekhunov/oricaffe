      ...
      <div className="container">
        <div className="footer__bottom">
          ...
          <div className="footer__item">
            <div className="footer__headline">Меню</div>
            <ul>
              <li>Услуги</li>
              <li>Качество</li>
              <li>Контакты</li>
          ...
          <div className="footer__item">
            <div className="footer__headline">О компании</div>
          ...
          <div className="footer__item">
            <div className="footer__headline">Юридический материал</div>
          ...
          <div className="footer__item">
            <div className="footer__headline">Найти нас в социальных сетях</div>
